...
var npm_conf_1 = require("./utils/npm_conf");
var path = require("path");
var generator_1 = require("./lib/generator");
module.exports = {
    setConfig: function () {
    },
    createPkg: function (name, targetDir) {
        if (targetDir === void 0) { targetDir = process.cwd(); }
        return __awaiter(this, void 0, void 0, function () {
            var target, metaData, results, templateDir, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        target = path.resolve(targetDir, "./" + name);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 6, , 7]);
                        return [4, file_1.default.checkExistFolder(target, true)];
                    case 2:
                        if (_a.sent()) {
                            return [2, {
                                    success: false,
                        ...
                        return [4, npm_conf_1.default(target)];
                    case 3:
                        metaData = _a.sent();
                        return [4, prompt_1.default(metaData)];
                    case 4:
                        results = _a.sent();
